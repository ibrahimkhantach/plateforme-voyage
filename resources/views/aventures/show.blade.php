    ...
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 mb-6 overflow-hidden border border-gray-100 dark:border-zinc-700">

                    <!-- User Info Header -->
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-zinc-700 bg-gradient-to-r from-gray-50 to-white dark:from-zinc-800 dark:to-zinc-800">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 mr-3">
                                    ...
                                    @else
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center font-bold text-lg ring-2 ring-indigo-500">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3 flex items-center text-sm">
                            <svg class="w-5 h-5 mr-2 text-indigo-600 dark:text-indigo-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed text-sm line-clamp-3">{{ $adventure->details }}</p>

                    </div>

                    <!-- Adventure Images Carousel -->
                    @if(!empty($images) && count($images) > 0)
                    <div class="relative border-t border-gray-200 dark:border-zinc-700" x-data="{ currentSlide: 0, totalSlides: {{ count($images) }} }">
                        ...
                        <!-- Image Counter -->
                        @if(count($images) > 1)
                        <div class="absolute top-3 right-3 bg-black/75 text-white px-3 py-1 rounded-full text-xs font-semibold">
